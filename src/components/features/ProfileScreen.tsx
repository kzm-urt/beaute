  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-5 py-10"
      ...
      <div className="text-center mb-8">
        <h1 className="text-[34px] italic tracking-[4px] mb-2"
          style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", color: "#F5EEE4" }}>
          beauté
        </h1>
      ...
      <p onClick={onComplete} className="text-center mt-3 text-[12px] cursor-pointer"
